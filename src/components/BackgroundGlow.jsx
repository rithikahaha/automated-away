export default function BackgroundGlow() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-bg">
      ...
      <div className="absolute left-1/4 top-0 h-[28rem] w-[28rem] animate-blob rounded-full bg-accent/20 blur-[100px]" />
      <div className="absolute right-1/4 top-40 h-[24rem] w-[24rem] animate-blob rounded-full bg-accent2/10 blur-[100px] [animation-delay:4s]" />
